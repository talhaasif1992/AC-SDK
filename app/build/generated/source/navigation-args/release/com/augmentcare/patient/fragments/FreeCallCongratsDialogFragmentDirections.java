...
public class FreeCallCongratsDialogFragmentDirections {
  private FreeCallCongratsDialogFragmentDirections() {
  }

  @NonNull
  public static ActionFreeCallCongratsDialogFragmentToInstantAppointmentFragment actionFreeCallCongratsDialogFragmentToInstantAppointmentFragment() {
    return new ActionFreeCallCongratsDialogFragmentToInstantAppointmentFragment();
  }

  @NonNull
  public static ActionFreeCallCongratsDialogFragmentToDoctorProfileFragment actionFreeCallCongratsDialogFragmentToDoctorProfileFragment(@NonNull String doctorID) {
    return new ActionFreeCallCongratsDialogFragmentToDoctorProfileFragment(doctorID);
  }
  ...
  public static class ActionFreeCallCongratsDialogFragmentToInstantAppointmentFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionFreeCallCongratsDialogFragmentToInstantAppointmentFragment() {
    }

    @NonNull
    public ActionFreeCallCongratsDialogFragmentToInstantAppointmentFragment setDoctorID(@Nullable String doctorID) {
      this.arguments.put("doctorID", doctorID);
      return this;
    }

    @NonNull
    public ActionFreeCallCongratsDialogFragmentToInstantAppointmentFragment setOrderID(@Nullable String orderID) {
      this.arguments.put("orderID", orderID);
      return this;
    }

    @NonNull
    public ActionFreeCallCongratsDialogFragmentToInstantAppointmentFragment setDoContinue(boolean doContinue) {
    ...
    public int getActionId() {
      return R.id.action_freeCallCongratsDialogFragment_to_instantAppointmentFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionFreeCallCongratsDialogFragmentToInstantAppointmentFragment that = (ActionFreeCallCongratsDialogFragmentToInstantAppointmentFragment) object;
    ...
    public String toString() {
      return "ActionFreeCallCongratsDialogFragmentToInstantAppointmentFragment(actionId=" + getActionId() + "){"
  ...
  public static class ActionFreeCallCongratsDialogFragmentToDoctorProfileFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionFreeCallCongratsDialogFragmentToDoctorProfileFragment(@NonNull String doctorID) {
      if (doctorID == null) {
    ...
    @NonNull
    public ActionFreeCallCongratsDialogFragmentToDoctorProfileFragment setDoctorID(@NonNull String doctorID) {
      if (doctorID == null) {
        throw new IllegalArgumentException("Argument \"doctorID\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("doctorID", doctorID);
    ...
    @NonNull
    public ActionFreeCallCongratsDialogFragmentToDoctorProfileFragment setShowBookAppointmentBtn(boolean showBookAppointmentBtn) {
      this.arguments.put("show_book_appointment_btn", showBookAppointmentBtn);
      return this;
    }

    @NonNull
    public ActionFreeCallCongratsDialogFragmentToDoctorProfileFragment setDoctor(@Nullable DoctorInfoLimited doctor) {
      this.arguments.put("doctor", doctor);
      return this;
    }

    @NonNull
    public ActionFreeCallCongratsDialogFragmentToDoctorProfileFragment setInstantDoctor(@NonNull String instantDoctor) {
    ...
    @Override
    public int getActionId() {
      return R.id.action_freeCallCongratsDialogFragment_to_doctorProfileFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionFreeCallCongratsDialogFragmentToDoctorProfileFragment that = (ActionFreeCallCongratsDialogFragmentToDoctorProfileFragment) object;
      if (arguments.containsKey("doctorID") != that.arguments.containsKey("doctorID")) {
        return false;
      }
      if (getDoctorID() != null ? !getDoctorID().equals(that.getDoctorID()) : that.getDoctorID() != null) {
    ...
    @Override
    public String toString() {
      return "ActionFreeCallCongratsDialogFragmentToDoctorProfileFragment(actionId=" + getActionId() + "){"
          + "doctorID=" + getDoctorID()
