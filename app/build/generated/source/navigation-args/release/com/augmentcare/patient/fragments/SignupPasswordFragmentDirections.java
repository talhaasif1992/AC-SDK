...
public class SignupPasswordFragmentDirections {
  ...
  @NonNull
  public static ActionSignupPasswordFragmentToOTPFragment actionSignupPasswordFragmentToOTPFragment(@Nullable String password,
      @NonNull String email, @NonNull String phone) {
    return new ActionSignupPasswordFragmentToOTPFragment(password, email, phone);
  }

  public static class ActionSignupPasswordFragmentToOTPFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionSignupPasswordFragmentToOTPFragment(@Nullable String password,
        @NonNull String email, @NonNull String phone) {
    ...
    @NonNull
    public ActionSignupPasswordFragmentToOTPFragment setPassword(@Nullable String password) {
      this.arguments.put("password", password);
      return this;
    }

    @NonNull
    public ActionSignupPasswordFragmentToOTPFragment setIsForgotPassword(boolean isForgotPassword) {
      this.arguments.put("isForgotPassword", isForgotPassword);
      return this;
    }

    @NonNull
    public ActionSignupPasswordFragmentToOTPFragment setEmail(@NonNull String email) {
      if (email == null) {
        throw new IllegalArgumentException("Argument \"email\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("email", email);
    ...
    @NonNull
    public ActionSignupPasswordFragmentToOTPFragment setIsGoogleSignUp(boolean isGoogleSignUp) {
      this.arguments.put("is_google_sign_up", isGoogleSignUp);
      return this;
    }

    @NonNull
    public ActionSignupPasswordFragmentToOTPFragment setPhone(@NonNull String phone) {
      if (phone == null) {
        throw new IllegalArgumentException("Argument \"phone\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("phone", phone);
    ...
    @NonNull
    public ActionSignupPasswordFragmentToOTPFragment setFromSignUpFlow(boolean fromSignUpFlow) {
    ...
    public int getActionId() {
      return R.id.action_signupPasswordFragment_to_OTPFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionSignupPasswordFragmentToOTPFragment that = (ActionSignupPasswordFragmentToOTPFragment) object;
    ...
    public String toString() {
      return "ActionSignupPasswordFragmentToOTPFragment(actionId=" + getActionId() + "){"
