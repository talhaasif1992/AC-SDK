...
public class AppointmentApprovedFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private AppointmentApprovedFragmentArgs() {
  }

  private AppointmentApprovedFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static AppointmentApprovedFragmentArgs fromBundle(@NonNull Bundle bundle) {
    AppointmentApprovedFragmentArgs __result = new AppointmentApprovedFragmentArgs();
    bundle.setClassLoader(AppointmentApprovedFragmentArgs.class.getClassLoader());
    ...
    if (bundle.containsKey("exporeInstantModelResponseObj")) {
      BookedInstantAppointmentSlot exporeInstantModelResponseObj;
      if (Parcelable.class.isAssignableFrom(BookedInstantAppointmentSlot.class) || Serializable.class.isAssignableFrom(BookedInstantAppointmentSlot.class)) {
        exporeInstantModelResponseObj = (BookedInstantAppointmentSlot) bundle.get("exporeInstantModelResponseObj");
      } else {
      ...
      __result.arguments.put("exporeInstantModelResponseObj", exporeInstantModelResponseObj);
    }
    ...
    if (bundle.containsKey("isFromExplorePayment")) {
      boolean isFromExplorePayment;
      isFromExplorePayment = bundle.getBoolean("isFromExplorePayment");
      __result.arguments.put("isFromExplorePayment", isFromExplorePayment);
    }
  ...
  public boolean equals(Object object) {
    ...
    AppointmentApprovedFragmentArgs that = (AppointmentApprovedFragmentArgs) object;
  ...
  public String toString() {
    return "AppointmentApprovedFragmentArgs{"
        + "doctor=" + getDoctor()
  ...
  public static class Builder {
    ...
    public Builder(AppointmentApprovedFragmentArgs original) {
    ...
    @NonNull
    public AppointmentApprovedFragmentArgs build() {
      AppointmentApprovedFragmentArgs result = new AppointmentApprovedFragmentArgs(arguments);
      return result;
    }
    ...
    @NonNull
    public Builder setExporeInstantModelResponseObj(@Nullable BookedInstantAppointmentSlot exporeInstantModelResponseObj) {
    ...
    @NonNull
    public Builder setIsFromExplorePayment(boolean isFromExplorePayment) {
