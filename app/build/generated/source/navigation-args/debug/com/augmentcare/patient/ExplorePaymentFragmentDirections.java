...
public class ExplorePaymentFragmentDirections {
  private ExplorePaymentFragmentDirections() {
  }

  @NonNull
  public static ActionExplorePaymentFragmentToAppointmentApprovedFragment actionExplorePaymentFragmentToAppointmentApprovedFragment() {
    return new ActionExplorePaymentFragmentToAppointmentApprovedFragment();
  }
  ...
  public static class ActionExplorePaymentFragmentToAppointmentApprovedFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionExplorePaymentFragmentToAppointmentApprovedFragment() {
    }

    @NonNull
    public ActionExplorePaymentFragmentToAppointmentApprovedFragment setDoctor(@Nullable DoctorInfoLimited doctor) {
      this.arguments.put("doctor", doctor);
      return this;
    }

    @NonNull
    public ActionExplorePaymentFragmentToAppointmentApprovedFragment setSelectedDate(@Nullable String selectedDate) {
      this.arguments.put("selectedDate", selectedDate);
      return this;
    }

    @NonNull
    public ActionExplorePaymentFragmentToAppointmentApprovedFragment setTime(@Nullable String time) {
      this.arguments.put("time", time);
      return this;
    }

    @NonNull
    public ActionExplorePaymentFragmentToAppointmentApprovedFragment setPateintName(@Nullable String pateintName) {
      this.arguments.put("pateintName", pateintName);
      return this;
    }

    @NonNull
    public ActionExplorePaymentFragmentToAppointmentApprovedFragment setType(@Nullable String type) {
      this.arguments.put("type", type);
      return this;
    }

    @NonNull
    public ActionExplorePaymentFragmentToAppointmentApprovedFragment setDependentId(@Nullable String dependentId) {
      this.arguments.put("dependentId", dependentId);
      return this;
    }

    @NonNull
    public ActionExplorePaymentFragmentToAppointmentApprovedFragment setAppointmentType(@Nullable String appointmentType) {
      this.arguments.put("appointmentType", appointmentType);
      return this;
    }

    @NonNull
    public ActionExplorePaymentFragmentToAppointmentApprovedFragment setDoctorDetailId(@Nullable String doctorDetailId) {
      this.arguments.put("doctorDetailId", doctorDetailId);
      return this;
    }

    @NonNull
    public ActionExplorePaymentFragmentToAppointmentApprovedFragment setMedicalPracticeId(@Nullable String medicalPracticeId) {
      this.arguments.put("medicalPracticeId", medicalPracticeId);
      return this;
    }

    @NonNull
    public ActionExplorePaymentFragmentToAppointmentApprovedFragment setMedicalPracticeName(@Nullable String medicalPracticeName) {
      this.arguments.put("medicalPracticeName", medicalPracticeName);
      return this;
    }

    @NonNull
    public ActionExplorePaymentFragmentToAppointmentApprovedFragment setInstantDoctor(@Nullable String instantDoctor) {
      this.arguments.put("instantDoctor", instantDoctor);
      return this;
    }

    @NonNull
    public ActionExplorePaymentFragmentToAppointmentApprovedFragment setExporeInstantModelResponseObj(@Nullable BookedInstantAppointmentSlot exporeInstantModelResponseObj) {
      this.arguments.put("exporeInstantModelResponseObj", exporeInstantModelResponseObj);
      return this;
    }

    @NonNull
    public ActionExplorePaymentFragmentToAppointmentApprovedFragment setExploreDoctorSuccessResponseObj(@Nullable EliteDoctorSuccess exploreDoctorSuccessResponseObj) {
      this.arguments.put("exploreDoctorSuccessResponseObj", exploreDoctorSuccessResponseObj);
      return this;
    }

    @NonNull
    public ActionExplorePaymentFragmentToAppointmentApprovedFragment setIsFromExplorePayment(boolean isFromExplorePayment) {
      this.arguments.put("isFromExplorePayment", isFromExplorePayment);
      return this;
    }

    @NonNull
    public ActionExplorePaymentFragmentToAppointmentApprovedFragment setStartTime(@Nullable String startTime) {
      this.arguments.put("startTime", startTime);
      return this;
    }

    @NonNull
    public ActionExplorePaymentFragmentToAppointmentApprovedFragment setEndTime(@Nullable String endTime) {
      this.arguments.put("endTime", endTime);
      return this;
    }

    @NonNull
    public ActionExplorePaymentFragmentToAppointmentApprovedFragment setPaymentMethodType(@Nullable String paymentMethodType) {
      this.arguments.put("paymentMethodType", paymentMethodType);
      return this;
    }

    @NonNull
    public ActionExplorePaymentFragmentToAppointmentApprovedFragment setCardId(@Nullable String cardId) {
      this.arguments.put("cardId", cardId);
      return this;
    }

    @NonNull
    public ActionExplorePaymentFragmentToAppointmentApprovedFragment setBookByUser(@Nullable String bookByUser) {
      this.arguments.put("bookByUser", bookByUser);
      return this;
    }

    @NonNull
    public ActionExplorePaymentFragmentToAppointmentApprovedFragment setPateintId(@Nullable String pateintId) {
    ...
    public int getActionId() {
      return R.id.action_explorePaymentFragment_to_appointmentApprovedFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionExplorePaymentFragmentToAppointmentApprovedFragment that = (ActionExplorePaymentFragmentToAppointmentApprovedFragment) object;
    ...
    public String toString() {
      return "ActionExplorePaymentFragmentToAppointmentApprovedFragment(actionId=" + getActionId() + "){"
          + "doctor=" + getDoctor()
