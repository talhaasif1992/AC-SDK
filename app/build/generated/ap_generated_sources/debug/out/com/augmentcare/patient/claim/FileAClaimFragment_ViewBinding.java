...
public class FileAClaimFragment_ViewBinding implements Unbinder {
  private FileAClaimFragment target;

  @UiThread
  public FileAClaimFragment_ViewBinding(FileAClaimFragment target, View source) {
    this.target = target;

    target.tilClaimAmount = Utils.findRequiredViewAsType(source, R.id.tilClaimAmount, "field 'tilClaimAmount'", TextInputLayout.class);
    ...
    target.etDetails = Utils.findRequiredViewAsType(source, R.id.etDetails, "field 'etDetails'", EditText.class);
    ...
    target.dependentsView = Utils.findRequiredViewAsType(source, R.id.dep_view, "field 'dependentsView'", DependentsView.class);
  }

  @Override
  @CallSuper
  public void unbind() {
    FileAClaimFragment target = this.target;
    if (target == null) throw new IllegalStateException("Bindings already cleared.");
    this.target = null;

    target.tilClaimAmount = null;
