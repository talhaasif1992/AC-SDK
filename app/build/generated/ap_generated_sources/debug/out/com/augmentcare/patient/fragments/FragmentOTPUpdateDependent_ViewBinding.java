...
public class FragmentOTPUpdateDependent_ViewBinding implements Unbinder {
  private FragmentOTPUpdateDependent target;

  @UiThread
  public FragmentOTPUpdateDependent_ViewBinding(FragmentOTPUpdateDependent target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FragmentOTPUpdateDependent target = this.target;
