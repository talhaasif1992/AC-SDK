...
public class AddDependentMemberFragment_ViewBinding implements Unbinder {
  private AddDependentMemberFragment target;

  @UiThread
  public AddDependentMemberFragment_ViewBinding(AddDependentMemberFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AddDependentMemberFragment target = this.target;
