...
public class PrescriptionDetail implements Serializable {
    ...
    @Expose
    private List<OrderResults> prescriptionsObject = new ArrayList<>();
    ...
    public List<OrderResults> getPrescriptionsObject() {
        return prescriptionsObject;
    }

    public void setPrescriptionsObject(List<OrderResults> prescriptionsObject) {
