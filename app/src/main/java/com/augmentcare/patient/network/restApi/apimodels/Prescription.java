...
public class Prescription implements Parcelable
{
    ...
    public final static Creator<Prescription> CREATOR = new Creator<Prescription>() {
    ...
    public Prescription withPaper(String paper) {
        this.paper = paper;
        return this;
    }
    ...
    public Prescription withPaperSize(String paperSize) {
        this.paperSize = paperSize;
        return this;
    }
    ...
    public Prescription withOrientation(String orientation) {
        this.orientation = orientation;
        return this;
    }
    ...
    public Prescription withMargins(Margins margins) {
        this.margins = margins;
        return this;
    }
