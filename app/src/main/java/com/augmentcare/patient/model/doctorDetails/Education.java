...
public class Education {
    ...
    public Education(Integer id, String name, String institution, String start, String end, String document1, String document2, Integer docterId, String createdAt, String updatedAt, String recordType, Boolean toDate) {
        this.id = id;
        this.name = name;
        this.institution = institution;
        this.start = start;
